...
import { Textarea } from "@/components/woof-ui/textarea";
import { cn } from "@/lib/utils";
import { useTextareaResize } from "@/components/woof-ui/hooks/use-textarea-resize";
...
function ChatInputSubmit({
  ...
  return (
    <Button
      className={cn(
        " bg-[#6268eb] hover:bg-[#f5a96b] shrink-0 rounded-full p-1.5 h-fit border dark:border-zinc-600",
        className
      )}
      disabled={isDisabled}
      onClick={(event) => {
